    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 pt-10 sm:pt-24 pb-8 sm:pb-8">
        <div class="grid grid-cols-2 gap-4 sm:gap-6 gap-x-24 sm:grid-cols-3 mx-2">
            ...
            <div class="flex flex-col items-start sm:items-end text-right">
                <h5 class="mb-2 sm:mb-6 text-xs sm:text-sm font-primary leading-7 tracking-tight text-darkpink uppercase">Információ</h5>
                <ul class="text-xs sm:text-sm font-primary leading-7 tracking-tight text-black">
                    <li class="mb-1 sm:mb-4">
                        <?php
                        ...
                        if ($privacy_policy_url) {
                            echo '<a href="' . esc_url($privacy_policy_url) . '" target="_blank" rel="noopener noreferrer" class="hover:text-darkpink text-center">Adatkezelés</a>';
                        }
                        ?>
                    </li>
                    <li class="mmb-1 sm:mb-4">
                        <a href="<?php echo get_permalink(get_page_by_title('Impresszum')); ?>" class="hover:text-darkpink">Impresszum</a>
                    </li>
                </ul>
            </div>
