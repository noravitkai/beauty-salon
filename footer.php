        ...
        <div class="grid grid-cols-2 gap-4 sm:gap-6 gap-x-24 sm:grid-cols-3 mx-2">
            <div class="flex flex-col justify-start items-start">
                ...
                <ul class="text-xs sm:text-sm font-primary leading-7 tracking-tight text-black">
                    ...
                    <a href="<?php echo get_permalink(get_page_by_title('Főoldal')); ?>" class="hover:text-darkpink">Főoldal</a>
                    </li>
                    <li class="mb-1 sm:mb-4">
            ...
            <div class="flex flex-col items-start sm:items-center">
                ...
                <ul>
                    <li class="mb-4">
                    <a href="#" class="text-lightpink hover:text-darkpink">
                ...
                <ul class="text-xs sm:text-sm font-primary leading-7 tracking-tight text-black">
                    <li class="mb-1 sm:mb-4">
                        ...
                        if ($privacy_policy_url) {
                            echo '<a href="' . esc_url($privacy_policy_url) . '" target="_blank" class="hover:text-darkpink text-center">Szabályzat</a>';
                        }
                        ?>
                    </li>
                </ul>
